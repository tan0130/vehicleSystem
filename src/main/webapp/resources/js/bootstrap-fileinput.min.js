...
!function (e) {
    ...
    e.fn.fileinputLocales = {}, e.fn.fileinputThemes = {}, String.prototype.setTokens = function (e) {
        ...
        constructor: i, _cleanup: function () {
            ...
            this._raise("filebrowse"), e && e.isDefaultPrevented() || (this.isError && !this.isAjaxUpload && this.clear(), this.$captionContainer.focus())
            ...
            r.loadedImages = [], r.totalImagesCount = 0, e.each(i, function (e, t) {
                ...
                if (B) {
                    ...
                    if (!1 !== M) {
                        if (0 === M.length) return S = r.msgInvalidFileName.replace("{name}", t.htmlEncode(B.name)), void y(S, B, U, x);
